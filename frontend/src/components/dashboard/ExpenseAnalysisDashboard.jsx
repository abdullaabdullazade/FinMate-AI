                    ...
                    .map((category, index) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10 transition-all"
                        >
                ...
                {Object.keys(categoryData).length > 6 && (
                  <div className="mt-4 flex justify-center">
                    <button
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-lg text-white text-sm font-medium transition-all duration-300"
                    >
                      {showAllCategories 
                        ? `Daha az göstər` 
