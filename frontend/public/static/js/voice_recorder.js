...
class VoiceRecorder {
    ...
    async sendAudioToServer(audioBlob) {
        try {
            ...
            if (contentType && contentType.includes('text/html')) {
                ...
                // This ensures all scripts run in proper context
                ...
                scripts.forEach(oldScript => {
                    ...
                    // Wrap script content to ensure proper scope
    ...
    showError(msg) {
        ...
        // Add event listener to retry button (safer than inline onclick)
        ...
        if (retryBtn) {
            ...
            newRetryBtn.addEventListener('click', () => {
                if (window.voiceRecorder) {
                    window.voiceRecorder.resetRecording();
