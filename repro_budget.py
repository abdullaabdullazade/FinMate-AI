...
def test_scenario(budget_azn, currency, spending_eur):
    ...
    # Alert logic (Buggy)
    alert_remaining = user.monthly_budget - total_spending
    ...
    print(f"Alert Remaining (Buggy): {alert_remaining}")
    print("\n")

# Scenario A: Correctly stored AZN budget
test_scenario(8200, "EUR", 1941.98)

# Scenario B: Budget stored as EUR value (but treated as AZN)
test_scenario(4162.44, "EUR", 1941.98)
